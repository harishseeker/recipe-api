    ...
    list=extend_schema(
        parameters=[
            ...
            OpenApiParameter(
                'ingredients',
                OpenApiTypes.STR,
                description='list of ingredient ids for filtering.'
            )
        ]
    )
)
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if ingredients:
            ...
            query_set = query_set.filter(ingredients__id__in=ingredient_id)
    ...
    list=extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                description='Filter those assigned to recipes.',
            )
        ]
    )
)
